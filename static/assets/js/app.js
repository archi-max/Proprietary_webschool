...
(function(jQuery) {
 ...
 /*---------------------------------------------------------------------
    ...
    $('[data-extra-toggle="delete_homework"]').on('click', function (e) {
        ...
        .then((willDelete) => {
            if (willDelete.isConfirmed) {
                const announcementId = $(this).attr('work_id')
    ...
    $('[data-extra-toggle="delete_card"]').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
        ...
        .then((willDelete) => {
            if (willDelete.isConfirmed) {
                const notesId = $(this).attr('note_id')
                const ann_form = $(this).find("form")
                $.ajax({
                        type: "POST",
                        url: ann_form.attr('action'),
    ...
    $('[data-extra-toggle="delete_announcement"]').on('click', function (e) {
        const closestElem = $(this).attr('data-closest-elem')
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
              confirmButton: 'btn btn-primary',
        ...
        .then((willDelete) => {
            if (willDelete.isConfirmed) {
                const announcementId = $(this).attr('announcement_id')
                const ann_form = $('#announcement_'+announcementId)
                $.ajax({
                        type: "POST",
                        url: ann_form.attr('action'),
                        data: ann_form.serialize(), // serializes the form's elements.
